...
class Help(commands.Cog):
	...
	async def help(self, ctx):
		...
		help_embed.add_field(name = "💬 Embed Commands", value = "> `/embed <subcommands>` - **These commands will help you build an embed that can easily be made and will be used by bot to greet someone when they open a new thread.**", inline = False)
		help_embed.add_field(name = "🔗 Links", value = "> [Support Server](https://discord.gg/cortexbotservices) | [Invite](https://ptb.discord.com/api/oauth2/authorize?client_id=1067744805607718962&permissions=498216594640&scope=applications.commands%20bot) | [Vote](https://top.gg/bot/937726571291238411/vote) | [Github](https://github.com/cannonballchris/Indigo-Mail)", inline = False)
